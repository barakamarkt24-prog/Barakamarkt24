...
export const DEFAULT_ANNOUNCEMENTS: AnnouncementItem[] = [
  { 
    ...
    textAr: 'شحن سريع لباب منزلك في غرايفسفالد والمناطق المجاورة 🚚',
    textDe: 'Schnelle Lieferung direkt an Ihre Haustür in Greifswald und Umgebung 🚚',
    textEn: 'Fast delivery right to your doorstep in Greifswald and surrounding areas 🚚',
    textUk: 'Швидка доставка до ваших дверей у Грайфсвальді та околицях 🚚',
    textFa: 'ارسال سریع درب منزل شما در گرایفسوالد و مناطق اطراف 🚚',
    isActive: true, 
    order: 1, 
    icon: 'truck', 
    isHighlight: false,
  ...
  { 
    ...
    textAr: 'أجود المنتجات العربية والعالمية طازجة وبأفضل الأسعار 🌟',
    textDe: 'Beste arabische und internationale Produkte frisch zu Top-Preisen 🌟',
    textEn: 'Finest Arabic and international products fresh at the best prices 🌟',
    textUk: 'Найкращі арабські та світові продукти свіжі за найкращими цінами 🌟',
    textFa: 'بهترین محصولات عربی و بین‌المللی تازه و با بهترین قیمت 🌟',
    isActive: true, 
    order: 2, 
    icon: 'shield', 
    isHighlight: false,
  ...
  { 
    ...
    textAr: 'تخفيضات أسبوعية وعروض حصرية متجددة في متجر بركة ماركت 24 🏷️',
    textDe: 'Wöchentliche Rabatte und exklusive Angebote bei Baraka Markt 24 🏷️',
    textEn: 'Weekly discounts and exclusive recurring offers at Baraka Markt 24 🏷️',
    textUk: 'Щотижневі знижки та ексклюзивні пропозиції в Baraka Markt 24 🏷️',
    textFa: 'تخفیف‌های هفتگی و پیشنهادهای ویژه جدید در برکت مارکت ۲۴ 🏷️',
    isActive: true, 
    order: 3, 
    icon: 'tag', 
    isHighlight: true,
